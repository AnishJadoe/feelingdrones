...
# axes[0].set_xticklabels(np.linspace(min(x_points_ellipse), max(x_points_ellipse), num_ticks))
# axes[0].set_yticklabels(np.linspace(min(y_points_ellipse), max(y_points_ellipse), num_ticks))
# axes[0].set_zticklabels(np.linspace(min(z_points_ellipse), max(z_points_ellipse), num_ticks))
