...
struct __attribute__((__packed__)) serial_act_t4_in {
    ...
    // Servo speed  
    int16_t servo_1_speed_int; //Degrees * 100 
    int16_t servo_2_speed_int; //Degrees * 100 
    int16_t servo_3_speed_int; //Degrees * 100 
    int16_t servo_4_speed_int; //Degrees * 100 
    // mode
    uint8_t servo_1_working_mode_int; // Choose between either position or velocity mode
    uint8_t servo_2_working_mode_int; // Choose between either position or velocity mode
    uint8_t servo_3_working_mode_int; // Choose between either position or velocity mode
    uint8_t servo_4_working_mode_int; // Choose between either position or velocity mode
    //Rolling message out
...
#define SBS_CURRENT_WORKING_MODE 33
#define SBS_POSITION_OFFSET 31
